...
import az.unitech.auth.security.RefreshJwtRequest;
import az.unitech.auth.service.LoginService;
...
public class LoginController {
    ...
    @GetMapping("/getPinFromToken")
    public ResponseEntity<?> getPinFromToken(){
        return ResponseEntity.ok(authService.getPinFromToken());
    }
